...
def main():
    ...
    #     print(d)
    nn = u"wo我节日哦安乐的师傅看见啊手机费 i 哦挖掘饿啊李开复卡勒季斯的风景哦爱就违法礼卡就是快乐的卷发哦 is 的减肥了啊我看见俄方哦爱就啥都发生的快放假啦说的减肥啊哦 is 的家发了说的减肥克拉结束的立法精神动力飞机啊老师都快解放啦是江东父老啊是江东父老啊绝世独立封口机阿拉山口的减肥阿里看到减肥la"
